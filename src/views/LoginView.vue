    ...
    <form class="container" @submit.prevent="handleSubmit">
      ...
      <div class="form-group mb-3 position-relative">
        ...
        <button type="button" class="toggle-password" @click="togglePassword">
          <img :src="passwordVisible ? require('@/assets/img/ojo-abierto.png') : require('@/assets/img/ojo-cerrado.png')" alt="Toggle Password Visibility" class="eye-icon"  />
        </button>
      </div>
...
import { signInWithEmailAndPassword, sendPasswordResetEmail } from 'firebase/auth'; // Importar el método para iniciar sesión
...
export default {
  data() {
    return {
      correo: '',
      password: '',
      passwordVisible: false, // Estado para mostrar/ocultar contraseña
    };
  },
  methods: {
    togglePassword() {
...
.body {
  min-height: 100vh; /* Asegura que el contenedor ocupe al menos el 100% de la altura */
  display: flex;
  align-items: center;
